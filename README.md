...
ln -s ~/projects/agent-skills/spdd-design ~/.claude/skills/spdd-design
ln -s ~/projects/agent-skills/spdd-implement ~/.claude/skills/spdd-implement
ln -s ~/projects/agent-skills/spdd-verify ~/.claude/skills/spdd-verify
ln -s ~/projects/agent-skills/spdd-sync ~/.claude/skills/spdd-sync
ln -s ~/projects/agent-skills/spdd-migrate ~/.claude/skills/spdd-migrate
```
